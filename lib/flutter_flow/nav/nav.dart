...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Authenticate1',
          path: '/authenticate1',
          builder: (context, params) => Authenticate1Widget(),
        ),
        FFRoute(
          name: 'ForgetPassword',
          path: '/forgetPassword',
        ...
        FFRoute(
          ...
          path: '/contribution',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Contribution')
              : ContributionWidget(),
        ),
        FFRoute(
          name: 'Profile',
        ...
        FFRoute(
          ...
          builder: (context, params) => MoreDetailsWidget(
            place_id: params.getParam('place_id', ParamType.String),
          ),
        ),
        FFRoute(
