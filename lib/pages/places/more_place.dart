...
class MorePlacesWidget extends StatefulWidget {
   MorePlacesWidget({Key? key}) : super(key: key);

  @override
  _MorePlacesWidget createState() => _MorePlacesWidget();
}

class _MorePlacesWidget extends State<MorePlacesWidget> {
